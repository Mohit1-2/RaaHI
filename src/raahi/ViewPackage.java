...
public class ViewPackage extends JFrame implements ActionListener {
  ...
  heading.setBounds(60,0,300,30);
   ...
   add(l6);
    ...
    JLabel l7= new JLabel("TotalPrice");
   ...
   add(l7);
    ...
    new ViewPackage("Mohit").setVisible(true);
